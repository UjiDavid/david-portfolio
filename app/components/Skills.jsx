...
import { css, github, html, javascript, mongo, node, nextjs, reactImg, tailwind } from '../../public/assets';

const Skills = () => {
  return (
    <div id="skills" className="w-full lg:h-screen p-2">
      <div className="max-w-[1240px] mx-auto flex flex-col justify-center h-full">
        <p className="text-xl tracking-widest uppercase text-[#fcb00b]">Skills</p>
